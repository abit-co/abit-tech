...
define(['silkrouter', 'silkrouter/operators'], function (silkrouter, operators) { 'use strict';

  silkrouter = silkrouter && Object.prototype.hasOwnProperty.call(silkrouter, 'default') ? silkrouter['default'] : silkrouter;
